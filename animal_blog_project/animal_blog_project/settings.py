...
"""
Django settings for animal_blog_project project.
...
SECRET_KEY = 'django-insecure-&zx2r^f^&ddthau7x)+366m#4*zxh3!z)bn_*7iew3s(mi%d$$'
...
ROOT_URLCONF = 'animal_blog_project.urls'
